    ...
    <main className="p-3 max-w-4xl mx-auto my-auto">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="font-semibold text-slate-600 ">{selectedTemperaments.length > 0 ? "Temperaments selected:" : ''} <span className="font-normal text-slate-500">{selectedTemperaments.join(', ')}</span></p>
          <div className="flex flex-col gap-3 flex-1 md:mt-0">
            ...
            <div className="flex">
              <input onChange={(e) => setFiles(e.target.files)} className="p-2 text-slate-500 rounded ?" type="file" id='images' accept="image/*" multiple />
        ...
        <p className='col-span-2 text-green-800 mt-5 flex justify-center'>{updateSuccess ? 'Dog created successfully!' : ''}</p>
